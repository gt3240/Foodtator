        ...
        public static Options Options
        {
            get
            {
                if (_options == null)
                {
                    ...
                    {
                        AccessToken ="QtFvu4D-HRGPP86Y89Bu90OkmM47WKlf",
                        AccessTokenSecret = "7MIPtJczpkaXdsOSvJkLBAro8-E",
                        ConsumerKey = "JoyXvd8QkThQl0bLgeCEpw",
                        ConsumerSecret = "8ALKtityt_jf6MjgjjFcV3urfAE"
                    };
