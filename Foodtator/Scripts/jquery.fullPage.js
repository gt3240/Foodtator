...
(function($) {
	$.fn.fullpage = function(options) {
		...
		options = $.extend({
			...
			'loopTop': false,
			'loopHorizontal': true,
			'autoScrolling': true, // Scroll todo
			'scrollOverflow': true, // Scroll section
			'css3': true,
			'paddingTop': 0,
			'paddingBottom': 0,
			'fixedElements': null,
		...
		*/
		...
		if (options.navigation) {
			$('body').append('<div id="fullPage-nav"><ul></ul><div class="online"></div></div>');
		...
		*/		
		...
		$(document).on({
			mouseenter: function(){
				...
				$('<div class="fullPage-tooltip ' + options.navigationPosition +'">' + tooltip + '<div class="arrow_menu"></div></div>').hide().appendTo($(this)).fadeIn(500);
			},
			mouseleave: function(){
		...
		*/
		function addSlidesNavigation(section, numSlides){
			...
			if(numSlides == 4){
				...
				section.append('<div class="conteslideTeam"><div class="fullPage-slidesNav"><ul></ul></div></div>');
